...
def parse_args():
    ...
    # Training parameters
    parser.add_argument("--per_device_batch_size", type=int, default=32,  # REDUCED FROM 8
                      help="Batch size per device (default: 4)")
    parser.add_argument("--gradient_accumulation_steps", type=int, default=1,  # INCREASED FROM 4
